/****************************************************/
/*****Start Solution Code from Block 20 Workshop*****/
/****************************************************/
const users = [
...
main();
/****************************************************/
/******End Solution Code from Block 20 Workshop******/
/****************************************************/

/****************************************************/
/**************Start Live Code Solution**************/
/****************************************************/
...
/* Prompt with a question at the end like the one below:

 * So, why should you care about using React if it does the same thing as JS? It
 * doesn't seem to actually save me any time.
 *
 * Let me show you how powerful React can be, but first let's take a look at
 * some slides.
 */
