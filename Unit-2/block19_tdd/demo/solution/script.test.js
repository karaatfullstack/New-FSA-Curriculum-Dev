...
describe('add', () => {
    describe('works with correct types', () => {
        ...
        test('returns a number', () => {
            expect(typeof code.add(1, 2)).toEqual('number');
        });
        ...
        describe('returns the correct sum for random numbers between -50 and 50', () => {
            test('returns the correct sum for random numbers between -50 and 50', () => {
                for (let i = 0; i < 100; i++) {
                    ...
                    expect(code.add(num1, num2)).toEqual(num1 + num2);
                }
            });
        });
    });
...
describe('subtract', () => {
    describe('works with correct types', () => {
        test('is a function', () => {
            expect(typeof code.subtract).toEqual('function');
        });
        test('returns a number', () => {
            expect(typeof code.subtract(1, 2)).toEqual('number');
        });
        ...
        describe('returns the correct difference for random numbers between -50 and 50', () => {
            test('returns the correct difference for random numbers between -50 and 50', () => {
                for (let i = 0; i < 100; i++) {
                    let num1 = Math.floor(Math.random() * 100) - 50;
                    let num2 = Math.floor(Math.random() * 100) - 50;
                    expect(code.subtract(num1, num2)).toEqual(num1 - num2);
                }
            });
        });
    });
...
describe('greet', () => {
    describe('works with correct types', () => {
        test('is a function', () => {
            expect(typeof code.greet).toEqual('function');
        });
        test('returns a string', () => {
            expect(typeof code.greet('name')).toEqual('string');
        });

        describe('returns the correct greeting for a given name', () => {
            test('returns the correct greeting for a given name', () => {
                expect(code.greet('your name')).toEqual('Hello, your name!');
            });
        });
        ...
        names.forEach((name) => {
            test(`returns the correct greeting for ${name}`, () => {
                expect(code.greet(name)).toEqual(`Hello, ${name}!`);
            });
        });
    });
});
...
describe('sum', () => {
    describe('works with correct types', () => {
        it('is a function', () => {
            expect(typeof code.sum).toEqual('function');
        });
        it('returns a number', () => {
            expect(typeof code.sum([1, 2])).toEqual('number');
        });
