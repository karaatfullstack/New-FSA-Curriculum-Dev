...
console.log(pet1.birthday()); // Output: "Spot is 3 years old."

const pet2 = new Dog("Rover", 2, "Labrador");
console.log(pet2.birthday()); // Output: "Rover is 2 years old."
console.log(pet2.bark()); // Output: "Rover is barking!"

const pet3 = new Cat("Fluffy", 1, "white");
console.log(pet3.birthday()); // Output: "Fluffy is 1 year old."
